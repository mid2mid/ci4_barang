  ...
  <div class="login-box">
    ...
    <div class="card">
      <div class="card-body login-card-body">
        <p class="login-box-msg"><b>Panel Login User</b></p>
        <form action="<?= url_to('user.login.index') ?>" method="post">
          <?= csrf_field() ?>
        ...
        <div class="social-auth-links text-center mb-3">
          <p>- OR -</p>
          <a href="<?= url_to('admin.login.index') ?>" class="btn btn-block btn-primary">
            Login Sebagai Admin
          </a>
        </div>
        <!-- /.social-auth-links -->
